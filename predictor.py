...
class BasePredictor:
    ...
    def stream_inference(self, source=None, model=None):
        ...
        for batch in self.dataset:
            ...
            for i in range(n):
                ...
                inf_speed = profilers[1].dt * 1E3 / n
    ...
    def show(self, p,inf_speed):
        ...
        # Define the font, font scale, and font color
        # Your floating-point number
        your_float = inf_speed
        
        # Format it to have two decimal places
        formatted_number = "{:.2f} fps".format(1000/your_float)
        ...
        # Use cv2.putText to overlay the text on the image
        cv2.putText(im0, formatted_number, (x, y), font, font_scale, font_color, 3)
